...
import (
	...
	"NT106/Group01/MusicStreamingAPI/src/daemon"
	...
	//"NT106/Group01/MusicStreamingAPI/src/version"
	"NT106/Group01/MusicStreamingAPI/src/webserver"
...
const userAgentFormat = "Music Streaming API"
...
func getLibrary(
	...
	useragent := fmt.Sprintf(userAgentFormat, "dev-unreleased")
...
func runServer(appfs afero.Fs, sqlFilesFS fs.FS) error {
	...
	if !debug {
		err = helpers.SetLogsFile(
			appfs,
			helpers.AbsolutePath("music.log", userPath),
		)
		if err != nil {
